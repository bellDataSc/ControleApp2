...
st.title('Automação & Dados - FGV IBRE - Controle de Demandas')
...
# ---------- Equipe ----------
    ...
    equipe = [
        {'nome': 'LEANDRO', 'cargo': 'Coordenador', 'email': 'LE@FGV.com'},
        {'nome': 'ISABEL', 'cargo': 'Desenvolvedora', 'email': 'ISA@FGV.com'},
        {'nome': 'DOUGLAS', 'cargo': 'Desenvolvedor', 'email': 'DOGS@FGV.com'},
        {'nome': 'GUILHERME', 'cargo': 'Desenvolvedor', 'email': 'GUI@FGV.com'}
    ]
